...
(function (global) {
  ...
  var MSEC = {
    ...
    problem: { label: '문제 행동 대응', icon: 'shield', color: 'var(--c-problem)', bg: 'var(--c-problem-bg)',
               desc: '특정 상황에서의 대처 방법' },
        ...
        '<section class="section glow-sec alt">' +
          '<div class="lp-section">' +
            ...
            '<div class="grid grid-4">' + [
              ...
              { i: 'check',  t: '최소 입력',     d: '칩으로 탭만 해도 채워지는 빠른 작성 — 바쁜 일상에서도 부담 없이' },
  ...
  var dashboard = {
    ...
    render: function () {
      ...
      // 이렇게 쓰여요 — 3단계
      var steps = [
        { i: 'book',  t: '아이를 이해하는 항목 채우기', d: '좋아함·의사소통·감각·도전적 행동과 지원 방법까지. 칩으로 탭만 해도 채워져요.' },
