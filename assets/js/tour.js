...
(function (global) {
  ...
  function steps() {
    ...
    return [
      ...
      { hash: m, t: '② 입력은 탭 한 번이면 돼요', focus: '.manual-tabs',
        b: '카테고리마다 있는 빠른 입력 칩을 탭하면 문장이 바로 채워져요 — 타이핑을 최소화했어요. ‘한 줄 소개’와 ‘보호자 한마디’에는 부모님 목소리가 그대로 담깁니다.' },
  ...
  function render(st) {
    ...
    var sk = host.querySelector('[data-tour="skip"]'); if (sk) sk.onclick = teardown;
