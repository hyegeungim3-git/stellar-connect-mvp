    ...
    { key: 'share', ic: 'share', route: '#/share/:childId', label: '대상별 공유',
      ...
      steps: [
        ...
        { focus: '#btn-share-aud', t: '공유 만들기',
          b: '이 버튼을 누르면 받는 분 이름과 공유 기간(1일부터 계속 유지까지)을 정해 링크와 QR을 만들어요. 인증번호 사용 여부도 여기서 고를 수 있고, 기간이 끝나면 저절로 잠기니 한 번 열어 둔 정보가 계속 떠도는 걸 걱정하지 않으셔도 돼요.' },
        { focus: '.pill-info', t: '안전 장치',
          b: '인증번호를 켜 두면 번호를 아는 분만 열 수 있고, 5번 틀리면 링크가 저절로 잠겨요. 급할 때를 위해 인증번호 없이 바로 열리는 링크로 만들 수도 있어요. 비상연락처는 안심번호(050)로 가려서 보이는데, 이 프로토타입에서는 가상 번호로 보여 드리는 시뮬레이션이에요.' },
        { focus: '[data-qr]', t: '전달하고 관리하기',
          b: '지금 사용 중인 공유는 아래 목록에 모여요(중단·만료된 공유는 ‘전체 기록’에 보관돼요). ‘QR·키링 카드’를 인쇄하면 인증번호를 쓰는 공유는 번호가 카드에 함께 찍혀, 급할 때 곁의 분이 QR을 스캔해 확인할 수 있어요.' }
      ] },
